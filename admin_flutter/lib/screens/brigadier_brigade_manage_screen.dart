...
class BrigadierBrigadeManageScreen extends StatefulWidget {
  const BrigadierBrigadeManageScreen({super.key});

  @override
  State<BrigadierBrigadeManageScreen> createState() => _BrigadierBrigadeManageScreenState();
}

class _BrigadierBrigadeManageScreenState extends State<BrigadierBrigadeManageScreen> {
